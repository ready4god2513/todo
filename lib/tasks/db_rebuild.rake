namespace :db do
  ...
  task :rebuild, [:skip_seeds] => :environment do |t,args|
    raise "This task can not be run in this environment." unless %w[development alpha production].include? Rails.env
